...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import bmon_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d7e7cbe0-5b96-5c0f-b173-1d76374e957e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "bmon", artifacts_toml) for e in artifacts["bmon"]]
...
if best_platform === nothing
    @debug("Unable to load bmon; unsupported platform $(triplet(platform_key_abi()))")
else
